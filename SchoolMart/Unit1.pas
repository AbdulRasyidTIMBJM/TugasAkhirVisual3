...
type
  TForm1 = class(TForm)
    ...
    DataKeuangan1: TMenuItem;
    DataTransaksi1: TMenuItem;
    DataAkses1: TMenuItem;
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    Button1: TButton;
    ...
    procedure DataKeungan1Click(Sender: TObject);
    procedure DataTransaksi1Click(Sender: TObject);
    procedure DataAkses1Click(Sender: TObject);
...
procedure TForm1.DataKeungan1Click(Sender: TObject);
begin
if Form4=nil then
...
procedure TForm1.DataAksesSeluler1Click(Sender: TObject);
begin
if Form6=nil then
...
begin
if (edit1.Text='rasyid') and (edit2.Text='1234') then
   Menu1.Visible:=True;
